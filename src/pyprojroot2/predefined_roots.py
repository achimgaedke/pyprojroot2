...
# implement https://github.com/r-lib/rprojroot/blob/main/R/root.R#L349
...
# implement https://github.com/achimgaedke/pyprojroot2/blob/towards_v2/src/pyprojroot2/here.py#L17
